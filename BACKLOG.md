...
**Filled 16 of the 53** (37 remain) -- Gp126/128/129/130. These are the groundable ones: each is a
...
**Deliberately did NOT fill the remaining 37.** They differ in kind from every prose batch
...
actually encoded, then write the spec. Roughly 37 entries x per-file reading; the generator docstrings make it tractable and the Tsh section is now complete. Titles like
