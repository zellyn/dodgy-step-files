"""Wr048 — Writer-pathology fixture: Wr048 specific byte target."""
from step_corpus.step_builder import StepFile

f = StepFile(catalog_id="Wr048", defect="Wr048 post-pathology output")
...
# Wr048: needs STYLED_ITEM + MANIFOLD_SOLID_BREP
closed = f._emit_raw(f"CLOSED_SHELL(cs,(#{face.eid}))")
brep = f._emit_raw(f"MANIFOLD_SOLID_BREP(\\\"\\\",#{closed.eid})")
colour = f._emit_raw("COLOUR_RGB(\\\"\\\",0.5,0.5,0.5)")
...
f._emit_raw(f"STYLED_ITEM(\\\"\\\",(#{psa.eid}),#{brep.eid})")
