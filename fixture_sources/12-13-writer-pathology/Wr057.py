"""Wr057 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="Wr057",
             defect='Solvespace#1264: big-endian (s390x) writer emits empty STEP without diagnostic')
