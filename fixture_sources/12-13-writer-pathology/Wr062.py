"""Wr062 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="Wr062",
             defect='Blender gateway: MStep/STEPper addon converts STEP→mesh, color/assembly hierarchy lost')
