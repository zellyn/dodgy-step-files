"""Wr056 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="Wr056",
             defect='Solvespace#1589: writer aliases geometrically-identical entities (shared substructure)')
