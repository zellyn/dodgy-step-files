"""Pmi130 — THREAD feature with non-positive pitch (negative or zero).

Catalog claim: AP242 thread feature pitch must be strictly positive. This
fixture emits a SHAPE_ASPECT('thread') with nominal_diameter=10mm and
pitch=-1.5mm (negative). The helix is geometrically meaningless.
Receivers must reject or take abs(pitch) with a stable diagnostic.
...
f = StepFile(
    catalog_id="Pmi130",
    defect=(
        "thread SHAPE_ASPECT with nominal_diameter=10mm and pitch=-1.5mm; "
        "negative pitch is geometrically meaningless — "
...
# DEFECT: pitch=-1.5mm (negative) — geometrically meaningless
