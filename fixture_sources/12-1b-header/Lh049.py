"""Lh049 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="Lh049",
             defect='cascadio#2251: big-endian/s390x byte-order in OCCT wrapper drops shapes')
