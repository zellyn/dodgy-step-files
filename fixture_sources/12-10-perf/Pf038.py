"""Pf038 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="Pf038",
             defect='cascadio#22: STEP→GLB OOM, memory not released during translation pipeline')
