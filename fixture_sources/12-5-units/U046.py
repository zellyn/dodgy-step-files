"""U046 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="U046",
             defect='FreeCAD#29209: Link scaled with -1 not exported correctly — mirror-scale lost')
...
# Scale-by-(-1) mirror placement that the writer drops.
