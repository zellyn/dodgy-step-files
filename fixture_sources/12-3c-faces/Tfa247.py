"""Tfa247 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="Tfa247",
             defect='FreeCAD#20396: exported STEP produces empty objects — empty SHAPE_REPRESENTATION')
