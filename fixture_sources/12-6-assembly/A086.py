...
Catalog claim: writer uses a lazy-init module-static for the output schema;
once set at first call, reconfiguration is ignored. The bytes
'Writer ignores write.step.schema' or 'write.step.schema' must appear.
"""
from step_corpus.step_builder import StepFile

f = StepFile(catalog_id="A086",
             defect="Writer ignores write.step.schema — lazy-init module state freezes schema selection after first call; write.step.schema reconfiguration silently discarded")
