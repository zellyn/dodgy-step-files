...
Catalog claim: older AP203 (<=1998) hybrid models linked SDRs via
SHAPE_ASPECT rather than directly via PRODUCT_DEFINITION_SHAPE.
The bytes 'SHAPE_ASPECT' and 'legacy_link' must appear.
"""
from step_corpus.step_builder import StepFile

f = StepFile(catalog_id="A036",
             defect="AP203 1998-style SHAPE_ASPECT('legacy_link') mediates the SDR chain")
