...
Catalog claim: AP214 file using KINEMATIC_LINK_REPRESENTATION and
KINEMATIC_LINK_REPRESENTATION_RELATION (retired in AP242 Ed.1).
Both 'KINEMATIC_LINK_REPRESENTATION' and
'KINEMATIC_LINK_REPRESENTATION_RELATION' must appear as bytes.
"""
from step_corpus.step_builder import StepFile

f = StepFile(catalog_id="A031",
             defect="AP214 KINEMATIC_LINK_REPRESENTATION + KINEMATIC_LINK_REPRESENTATION_RELATION (retired in AP242e1)")
...
# STYLED_ITEM for assembly-presence lint.
colour = f._emit_raw("COLOUR_RGB('kin_color',0.5,0.5,0.5)")
...
f._emit_raw(f"STYLED_ITEM('si_kin',(#{psa.eid}),#{face.eid})")
...
# KINEMATIC_LINK_REPRESENTATION_RELATION — retired in AP242 Ed.1.
f._emit_raw(
    f"KINEMATIC_LINK_REPRESENTATION_RELATION('klr_rel','link_rel',"
    f"#{klr.eid},#{klr.eid})"
)
