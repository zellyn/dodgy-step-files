"""A110 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="A110",
             defect='IfcOpenShell#923: entity STEP id used for element naming on serialization')
