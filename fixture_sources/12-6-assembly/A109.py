"""A109 — pattern-mined fixture (see catalog for source).
...
f = StepFile(catalog_id="A109",
             defect='FreeCAD#11441: combining STEP files messes assembly tree')
...
# Tree-corruption defect: a NAUO references the wrong parent PRODUCT,
