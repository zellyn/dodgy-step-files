...
"""face on infinite-extent surface (PLANE has infinite param domain)"""
from step_corpus.step_builder import StepFile

f = StepFile(catalog_id="Sw005", defect="face on infinite-extent surface (PLANE has infinite param domain)")
