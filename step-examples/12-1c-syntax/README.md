...
| [In014](In014.stp) | `LoadONBrep` virtual-dispatch fall-through umbrella (BRL-CAD step-g) |
...
| [Ls010](Ls010.stp) | Complex / multiple-inheritance entity record: non-alphabetic leaf ordering |
...
| [Ls035](Ls035.stp) | Boolean attribute given `.U.` (LOGICAL UNKNOWN at BOOLEAN slot) |
| [Ls036](Ls036.stp) | Binary literal `"…"` malformed (bit-count nibble or hex case) |
| [Ls038](Ls038.stp) | Instance ID `#0` (must be positive non-zero) |
...
| [Ls047](Ls047.stp) | Complex / multiple-inheritance entity record: leaves separated by commas |
| [Ls048](Ls048.stp) | Complex / multiple-inheritance entity record: ancestor leaf omitted |
| [Ls049](Ls049.stp) | Boolean attribute given bare `TRUE` (no dots) |
| [Ls050](Ls050.stp) | Boolean attribute given long-form `.UNKNOWN.` |
| [Ls051](Ls051.stp) | Instance ID with 22 digits (overflows `uint64_t` accumulator) |
| [Ls052](Ls052.stp) | Instance ID just past `UINT64_MAX` wraps to a low-numbered ID |
| [Ls053](Ls053.stp) | REAL literal in an INTEGER-typed slot (`3.0` where `3` is required) |
| [Ls054](Ls054.stp) | Empty complex (subsuper) instance `#1=();` (zero constituent records) |
| [Ls055](Ls055.stp) | Unterminated block comment (no closing `*/`) swallows the file tail |
| [Ls056](Ls056.stp) | Non-nesting comment illusion; inner opener leaves a stray closer |
